      ...
      <div className="map-modal-content">
        ...
        <div className="map-modal-header">
          ...
          <h2 className="map-modal-title">
            {showAddressForm ? "Complete your address" : "Confirm location"}
          </h2>
        </div>
        ...
        {!showAddressForm ? (
          <>
              ...
              <div className="map-background">
                ...
                <div className="map-grid">
                  {[...Array(20)].map((_, i) => (
                    <div
                      key={`h-${i}`}
                      className="map-grid-line horizontal"
                      style={{ top: `${i * 5}%` }}
                    ></div>
                  ))}
                  {[...Array(20)].map((_, i) => (
                    <div
                      key={`v-${i}`}
                      className="map-grid-line vertical"
                      style={{ left: `${i * 5}%` }}
                    ></div>
                  ))}
                </div>
                ...
                {/* Location Markers */}
                <div className="map-marker" style={{ top: "25%", left: "45%" }}>
                  📍
                </div>
                <div className="map-marker" style={{ top: "60%", left: "75%" }}>
                  🏪
                </div>
                <div className="map-marker" style={{ top: "80%", left: "35%" }}>
                  🏥
                </div>
            ...
            <div className="map-location-details">
              {isLoadingLocation ? (
                <>
                  <h3 className="map-location-loading">
                  ...
                  {["Home", "Work", "Other"].map((type) => (
                    <button
                      ...
                      className={`map-address-type-btn ${
                        addressDetails.addressType === type ? "active" : ""
                      }`}
                      onClick={() =>
                        setAddressDetails((prev) => ({
                          ...prev,
