...
const FixedHeader: React.FC<FixedHeaderProps> = ({ onWishlistClick, onAccountClick }) => {
      ...
      <header className="fixed-header" role="banner">
        <div className="header-content">
          <div className="delivery-info">
            ...
            <div className="address-wrapper" onClick={() => setShowLocationModal(true)}>
          ...
          <div className="header-icons">
            ...
            <button 
              ...
              aria-label={isAuthenticated ? "Account (Profile)" : "Account (Login)"}
